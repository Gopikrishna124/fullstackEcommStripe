...
function AdminEditProductCard({data,onClose}) {
  ...
  return (
    <>
    <div className="fixed w-full h-full bg-blue-100 bg-opacity-5 top-0 bottom-0 right-0 left-0  flex justify-center items-center">
        <div className="bg-blue-50 p-3 rounded w-full max-w-2xl  h-full max-h-[80%] overflow-hidden">
          <div className="flex justify-between items-center">
            <h2 className="font-bold text-2xl ml-[200px]">Edit Product</h2>
